 ...
 * run Flow. */
const ReactPackager = require("@agiletechvn/metro-bundler");
/* $FlowFixMe(>=0.54.0 site=react_native_oss) This comment suppresses an error
 * found when Flow v0.54 was deployed. To see the error delete this comment and
 * run Flow. */
 ...
 * found when Flow v0.54 was deployed. To see the error delete this comment and
 * run Flow. */
import type { Reporter } from "@agiletechvn/metro-bundler/src/lib/reporting";
...
function getReporterImpl(customLogReporterPath: ?string) {
  if (customLogReporterPath == null) {
    return require("@agiletechvn/metro-bundler/src/lib/TerminalReporter");
  }
  try {
