...
const { Config: MetroConfig } = require("@agiletechvn/metro-bundler");

const RN_CLI_CONFIG = "rn-cli.config.js";

import type { ConfigT as MetroConfigT } from "@agiletechvn/metro-bundler";
...
function getProjectPath() {
  ...
  if (
    __dirname.match(
      /node_modules[\/\\]metro-bundler-cli[\/\\]local-cli[\/\\]util$/
    )
  ) {
